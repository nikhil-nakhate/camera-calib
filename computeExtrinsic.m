function [Tc_ext,Rc_ext,H_ext] = computeExtrinsic(fc,cc,kc,alpha_c,image_name,format_image,nX,nY,dX,dY)
...
% frame       = im2double(imread(ima_name));
% I           = mean(frame, 3);
% frame       = im2uint8(frame);
frame       = imread(ima_name);
I           = double(frame)/255;
...
wintx = 41; winty = 41;
[x_ext,X_ext,ind_orig,ind_x,ind_y] = extractGrid(I,frame,wintx,winty,fc,cc,kc,nX,nY,dX,dY);
