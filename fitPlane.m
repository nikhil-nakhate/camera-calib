function [w error] = fitPlane(X,Y,Z)
...
%    by the coefficient vector W, where W(1)*X + W(2)*Y +W(3)*Z = W(4), for
%    (X,Y,Z) on the plane P. error is the distance vector for the points
