...
% Normalize Hilbert curves, and expand (place points on them). Also return
% the subsegment indices for points. 
...
function [XPoints, SubSegmentIndices]   = NormalizeAndExpandHilbertCurvesForDecoding(X, delta, PointsPerSegment)
...
for i=1:NumSubSegments
    ...
    SubSegmentIndices       = [SubSegmentIndices i*ones(1, size(XPointsTmp, 2))];
end